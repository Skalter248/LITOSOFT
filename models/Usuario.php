<?php
    ...
    class Usuario {
        ...
        public function insert_usuario($usu_nombre, $usu_apellido_paterno, $usu_apellido_materno, $rol_id, $dep_id, $area_id, $pue_id, $usu_usuario_inicio, $usu_contraseña_inicio, $usu_telefono, $usu_RFC, $usu_CURP, $usu_NSS, $usu_domicilio, $usu_edad, $usu_fecha_nacimiento, $fecha_ingreso_planta, $usu_foto) {
            $conectar = $this->conectar();
            ...
            $sql = "INSERT INTO LS_USUARIOS (usu_nombre, usu_apellido_paterno, usu_apellido_materno, rol_id, usu_departamento, usu_area, usu_puesto, usu_usuario_inicio, usu_contraseña_inicio, usu_telefono, usu_RFC, usu_CURP, usu_NSS, usu_domicilio, usu_edad, usu_fecha_nacimiento, fecha_ingreso_planta, usu_foto, usu_estado, fecha_creacion) 
                    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 1, NOW())";
            ...
            $stmt->bindValue(5, $dep_id, PDO::PARAM_INT);
            $stmt->bindValue(6, $area_id, PDO::PARAM_INT);
            $stmt->bindValue(7, $pue_id, PDO::PARAM_INT);
            $stmt->bindValue(8, $usu_usuario_inicio);
            $stmt->bindValue(9, password_hash($usu_contraseña_inicio, PASSWORD_DEFAULT)); 
        ...
        public function update_usuario($usu_id, $usu_nombre, $usu_apellido_paterno, $usu_apellido_materno, $rol_id, $dep_id, $area_id, $pue_id, $usu_usuario_inicio, $usu_telefono, $usu_RFC, $usu_CURP, $usu_NSS, $usu_domicilio, $usu_edad, $usu_fecha_nacimiento, $fecha_ingreso_planta, $usu_foto) {
            $conectar = $this->conectar();
            ...
            $sql = "UPDATE LS_USUARIOS SET 
                        ...
                        usu_departamento = ?, usu_area = ?, usu_puesto = ?, usu_usuario_inicio = ?, 
            ...
            $stmt->bindValue(7, $pue_id, PDO::PARAM_INT);
            $stmt->bindValue(8, $usu_usuario_inicio);
            $stmt->bindValue(9, $usu_telefono);
            $stmt->bindValue(10, $usu_RFC);
            $stmt->bindValue(11, $usu_CURP);
            $stmt->bindValue(12, $usu_NSS);
            $stmt->bindValue(13, $usu_domicilio);
            $stmt->bindValue(14, $usu_edad, PDO::PARAM_INT);
            $stmt->bindValue(15, $usu_fecha_nacimiento);
            $stmt->bindValue(16, $fecha_ingreso_planta); // NUEVO
            $stmt->bindValue(17, $usu_foto);
            $stmt->bindValue(18, $usu_id, PDO::PARAM_INT);
