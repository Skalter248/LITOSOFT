        ...
        <div class="modal-content">
            <form method="post" id="solicitud_form"> 
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="vac_dias_naturales" id="vac_dias_naturales"> 
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="vac_dias_habiles" id="vac_dias_habiles" readonly value="0.00"> 
                        <small class="form-text text-muted" id="dias_habiles_info">Selecciona un rango de fechas para calcular los días.</small>
                    </div>
                    ...
                    <div id="alerta_saldo" class="alert alert-warning d-none" role="alert">
                        </div>
                </div>
