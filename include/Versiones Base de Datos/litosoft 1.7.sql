...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-11-2025 a las 23:46:27
...
--
-- Estructura de tabla para la tabla `ls_firmas`
--

CREATE TABLE `ls_firmas` (
  `firma_id` int(11) NOT NULL,
  `usu_id` int(11) NOT NULL,
  `firma_nombre_archivo` varchar(255) NOT NULL,
  `firma_ruta_completa` varchar(512) NOT NULL,
  `firma_fecha_subida` datetime DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

--
-- Volcado de datos para la tabla `ls_firmas`
--

INSERT INTO `ls_firmas` (`firma_id`, `usu_id`, `firma_nombre_archivo`, `firma_ruta_completa`, `firma_fecha_subida`) VALUES
(1, 12, 'IMARTINEZ_firma_1763591560.png', 'public/upload/firmas/IMARTINEZ_firma_1763591560.png', '2025-11-19 16:32:40'),
(2, 14, 'IGOMEZ_firma_1763591814.png', 'public/upload/firmas/IGOMEZ_firma_1763591814.png', '2025-11-19 16:36:54'),
(3, 13, 'OHERNANDEZ_firma_1763591828.jpeg', 'public/upload/firmas/OHERNANDEZ_firma_1763591828.jpeg', '2025-11-19 16:37:08');
...
(12, 'ISMAEL', 'MARTINEZ', 'VELASCO', 2, 13, 10, 4, 2, 'IMARTINEZ', '$2y$10$MlMztyqfjLovwRqVAlYrPOZv//zm8l4JIrO6l/DjD0tXt3YiwQc5q', '2216565674', 'MAVI99100QL8', 'MAVI99100HVRLS09', '2481309622', 'TRUFAS 31 A', 26, '1999-10-09', 'ISMAEL_MARTINEZ_1763433557.jpeg', '2025-11-17 20:39:17', '2025-11-19 13:45:28', '2023-06-15', NULL, 1),
...
(14, 'IVONNE', 'GOMEZ', 'ZEMPOATECATL', 1, 12, 10, 5, 2, 'IGOMEZ', '$2y$10$zeA9EWvXshVg1Gz29/HtROpWM/kauvxhxTeJPDniVOGHBNlvcOwMa', '2255778896', 'N/A2', 'N/A2', 'N/A2', 'N/A2', 26, '1999-10-20', 'IVONNE_GOMEZ_1763506138.jpeg', '2025-11-18 16:48:58', '2025-11-19 13:41:18', '2025-06-26', NULL, 1);
...
(1, '1900-01-01', '0000-00-00', 32.00, 32.00, 0.00, '0000-00-00 00:00:00', 125, '2025-11-19 16:44:02'),
(12, '2023-06-15', '2026-06-13', 0.00, 14.00, 14.00, '2025-11-17 21:05:02', 2, '2025-11-19 16:44:02'),
(13, '2022-06-22', '2026-06-22', 16.00, 16.00, 0.00, '2025-11-17 21:05:02', 3, '2025-11-19 16:44:02'),
(14, '2025-06-26', '0000-00-00', -3.00, 0.00, 3.00, '0000-00-00 00:00:00', 0, '2025-11-19 16:44:02');
...
INSERT INTO `ls_vacaciones_solicitudes` (`vac_id`, `usu_id`, `vac_fecha_inicio`, `vac_fecha_fin`, `vac_dias_habiles`, `vac_observaciones`, `vac_estado`, `vac_fecha_solicitud`, `usu_aprobador_id`, `vac_fecha_aprobacion`) VALUES
(2, 14, '2025-11-24', '2025-11-26', 3.00, '[SOLICITUD DE ADELANTO] VACACIONES FAMILIARES', 'Aprobada', '2025-11-19 13:33:57', 12, '2025-11-19 13:49:13'),
(3, 12, '2025-11-24', '2025-11-25', 2.00, '', 'Aprobada', '2025-11-19 13:44:04', 13, '2025-11-19 13:48:45'),
(4, 12, '2025-12-01', '2025-12-15', 11.00, '', 'Aprobada', '2025-11-19 14:36:06', 13, '2025-11-19 14:36:34'),
(5, 12, '2025-11-24', '2025-11-24', 1.00, '', 'Aprobada', '2025-11-19 15:32:34', 13, '2025-11-19 15:32:53');
...
--
-- Indices de la tabla `ls_firmas`
--
ALTER TABLE `ls_firmas`
...
--
-- AUTO_INCREMENT de la tabla `ls_firmas`
--
ALTER TABLE `ls_firmas`
  MODIFY `firma_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- Filtros para la tabla `ls_firmas`
--
ALTER TABLE `ls_firmas`
  ADD CONSTRAINT `FK_Firma_Usuario` FOREIGN KEY (`usu_id`) REFERENCES `ls_usuarios` (`usu_id`) ON DELETE CASCADE;
