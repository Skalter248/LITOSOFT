...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-11-2025 a las 09:43:51
...
(2, 'ISMAEL', 'MARTINEZ', 'VELASCO', 2, 3, 10, 4, 2, 'IMARTINEZ', '$2y$10$QA3soexhlHg6Eapm01/64eIAjLo86BYIV0X00fgtfel0WwyJByFhi', '2216565674', 'MAVI99100QL8', 'MAVI99100HVRLS09', '2481309622', 'TRUFAS 31 A', 26, '1999-10-09', 'ISMAEL_MARTINEZ_1763280032.jpeg', '2025-11-16 01:37:27', '2025-11-16 22:53:27', '2024-06-18', NULL, 1),
...
(4, 'IVONNE', 'GOMEZ', 'ZEMPOATECATL', 1, 2, 10, 5, 2, 'IGOMEZ', '$2y$10$tdXR.W2l7tzwBlRdZ5pYnOC5RlP80TYKxY8KYl7/swuDypaac1aCS', 'N/A', 'N/A1', 'N/A1', 'N/A1', 'N/A', 26, '1999-10-18', 'default.png', '2025-11-16 04:09:27', '2025-11-17 00:07:39', '2025-06-19', NULL, 1),
(5, 'ANTONIA', 'CONCHA', 'MOXO', 1, 2, 1, 1, 2, 'ACOMO', '$2y$10$PQ3BWY4dSJVZ9myBEoTBXe4qVJrmP6MizZDrR4pXt3nx5Tx.tpRgq', 'N/A', 'N/A2', 'N/A2', 'N/A2', 'N/A2', 34, '1991-05-14', 'default.png', '2025-11-17 00:49:35', NULL, '2025-10-01', NULL, 1),
(6, 'ALEXANDER', 'HERNANDEZ', 'LUNA', 1, 3, 10, 5, 2, 'AHERNANDEZ', '$2y$10$lJkP74qBb99IVz/dLvviiucOlOtJKbbUZkWmkVNqG5pmRwXGltOxu', 'N/A', 'N/A4', 'N/A4', 'N/A4', 'N/A4', 26, '1999-06-16', 'default.png', '2025-11-17 02:05:01', NULL, '2025-10-01', NULL, 1);
...
INSERT INTO `ls_vacaciones_solicitudes` (`vac_id`, `usu_id`, `vac_fecha_inicio`, `vac_fecha_fin`, `vac_dias_solicitados`, `vac_dias_habiles`, `vac_estado`, `vac_motivo_rechazo`, `vac_fecha_solicitud`, `vac_jefe_id_aprobador`, `vac_fecha_aprobacion`, `vac_justificacion_adelanto`) VALUES
(11, 2, '2025-11-24', '2025-11-27', 4, 4, 'Aprobada', NULL, '2025-11-17 01:56:51', 3, '2025-11-17 01:57:08', ''),
(12, 5, '2025-11-24', '2025-11-28', 5, 5, 'Aprobada', NULL, '2025-11-17 02:03:08', 2, '2025-11-17 02:03:23', 'POR DIAS FESTIVOS'),
(13, 6, '2025-12-22', '2025-12-27', 6, 5, 'Aprobada', NULL, '2025-11-17 02:05:41', 3, '2025-11-17 02:06:12', 'POR EVENTOS FAMILIARES'),
(14, 2, '2025-12-01', '2025-12-03', 3, 3, 'Cancelada', NULL, '2025-11-17 02:14:00', NULL, '2025-11-17 02:14:08', '');
...
--
ALTER TABLE `ls_usuarios`
  MODIFY `usu_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Clave primaria del usuario', AUTO_INCREMENT=7;
